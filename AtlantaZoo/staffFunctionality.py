...
class Ui_staffFunctionality(object):
    ...
    def userDefinedInitialization(self):
        self.SearchAnimalsPushButton.clicked.connect(self.searchAnimals)
        self.ViewShowsPushButton.clicked.connect(self.viewShows)
        self.LogoutPushButton.clicked.connect(self.logout)

    def searchAnimals(self):
        __main__.status = __main__.statusDef["Normal"]
        __main__.state = __main__.staffUIs['staffSearchAnimals']
        app.exit()

    def viewShows(self):
        __main__.status = __main__.statusDef["Normal"]
        __main__.state = __main__.staffUIs['staffViewShows']
        app.exit()

    def logout(self):
        __main__.status = __main__.statusDef["Normal"]
        __main__.state = __main__.staffUIs['logout']
        app.exit()
