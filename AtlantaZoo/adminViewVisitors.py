...
class Ui_adminViewVisitor(object):
    ...
    def userDefinedInitialization(self):
        self.searchVisitor.clicked.connect(self.loadData)
    ...
    def setupUi(self, adminViewStaff):
        ...
        self.searchVisitor = QtWidgets.QPushButton(self.splitter)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.searchVisitor.setFont(font)
        self.searchVisitor.setObjectName("searchVisitor")
        ...
        self.deleteVisitorButton = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.deleteVisitorButton.setFont(font)
        self.deleteVisitorButton.setObjectName("deleteVisitorButton")
        self.gridLayout.addWidget(self.deleteVisitorButton, 5, 2, 1, 1)
    ...
    def retranslateUi(self, adminViewStaff):
        ...
        self.label_2.setText(_translate("adminViewStaff", "View Visitors"))
        self.homeButton.setText(_translate("adminViewStaff", "Home"))
        self.label_3.setText(_translate("adminViewStaff", "Username"))
        self.searchVisitor.setText(_translate("adminViewStaff", "Search"))
        ...
        self.deleteVisitorButton.setText(_translate("adminViewStaff", "Delete Visitor"))
