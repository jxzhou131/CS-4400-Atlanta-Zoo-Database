...
class Ui_adminFunctionality(object):
    def setupUi(self, adminFunctionality):
        ...
        self.addAnimalsButton = QtWidgets.QPushButton(self.centralwidget)
        self.addAnimalsButton.setMinimumSize(QtCore.QSize(135, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.addAnimalsButton.setFont(font)
        self.addAnimalsButton.setObjectName("addAnimalsButton")
        self.gridLayout_6.addWidget(self.addAnimalsButton, 0, 1, 1, 1)
